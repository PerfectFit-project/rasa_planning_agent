...
class ActionShowTestimonials(Action):
    ...
    async def run(self, dispatcher: CollectingDispatcher,
            ...
            testimonials = ["This person introduces themselves as follows: 'Hello. I know I'm thin, but I have great stamina. I'm a big Pokémon go fan. I walk for 2 hours every day to collect as many virtual Pokémon as possible.' Their goal was: 'I think the best sport for me is walking. I walked 3.000 km last year. I played games and did sports.' The way they achieved this goal is described as: 'I achieved this by walking every day for 2 hours, that's about 8 km a day.' As you can see, what helped them was to follow a plan for doing physical activity.",
                            "This person introduces themselves as follows: 'Hi, I am very interested in exchanging our experiences. I run to increase my resistance.' Their goal was: 'I ran every day for 30 minutes.' The way they achieved this goal is described as: 'I achieved this by running every day for 30 minutes at least.' As you can see, what helped them was to follow a plan for doing physical activity.",
                            "This person introduces themselves as follows: 'I had been a bit of a couch potato before early retirement, however, during the last year I have taken up walking.' Their goal was: 'I reached over 10.000 steps in 24 hours.' The way they achieved this goal is described as: 'I achieved this by walking daily along beaches and in forests.' As you can see, what helped them was to follow a plan for doing physical activity.",
                            "This person introduces themselves as follows: 'I really like cycling on the weekends. I don't always feel like running so I try to sprint every time. If I'm able to I always walk to my destination.' Their goal was: 'I ran 100m in 12 seconds.' The way they achieved this goal is described as: 'I achieved this by sprinting 3 times a week.' As you can see, what helped them was to follow a plan for doing physical activity.",
                            "This person introduces themselves as follows: 'I really like to run and be active. I like going to the gym as well. I like challenges.' Their goal was: 'My goal was to run 10 km in under 40 minutes.' The way they achieved this goal is described as: 'I achieved this by training every day for a year.' As you can see, what helped them was to follow a plan for doing physical activity.",
                            "This person introduces themselves as follows: 'I'm 51, not really physically fit but trying. I've set myself walking and jogging goals through lockdown which I've achieved.' Their goal was: 'I walked and ran more during lockdown.' The way they achieved this goal is described as: 'I achieved this by walking more through lockdown, especially in the morning.' As you can see, what helped them was to follow a plan for doing physical activity.",
                            "This person introduces themselves as follows: 'I like to walk for an hour every day. I am looking to get back into table tennis weekly.' Their goal was: 'I have walked for an hour every day.' The way they achieved this goal is described as: 'I achieved this by writing a schedule every day and making sure to incorporate it into the framework.' As you can see, what helped them was to follow a plan for doing physical activity.",
                            "This person introduces themselves as follows: 'Hello, my name is Joseph and I'm a 29-year-old man who loves to run. I like outdoor running and I exercise 3-5 times per week.' Their goal was: 'I pushed myself to be able to run for a longer time with fewer pauses.' The way they achieved this goal is described as: 'I achieved this by keeping up with my running schedule. I ran faster to push myself. I ate better food and tried to eat at good times.' As you can see, what helped them was to follow a plan for doing physical activity."
                            ]
